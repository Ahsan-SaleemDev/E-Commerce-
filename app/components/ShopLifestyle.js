...
const lifestyles = [
  ...
  {
    name: "Plant based",
    desc: "Based on herbal ingredients",
    color: "#eaf1fb",
    className: "img2",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 76 76" fill="none">
        <path d="M9.5 72.8336C9.5 72.8336 9.875 42.7074 38 34.8336" stroke="currentColor" strokeWidth="2.5" strokeMiterlimit="10" strokeLinecap="round"></path>
        <path d="M11.1264 58.4427C7.13273 49.8272 -11.3834 1.3653 66.3117 6.74996C67.4008 6.74996 68.49 7.82689 68.8531 8.90382C70.6684 18.9552 74.6621 64.1863 13.6678 59.8786C12.2156 59.8786 11.4895 59.5196 11.1264 58.4427Z" stroke="currentColor" strokeWidth="2.5" strokeMiterlimit="10"></path>
      </svg>
    ),
  },
  {
    name: "Keto",
    desc: "Good fats served in food",
    color: "#feecec",
    className: "img3",
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 76 76" fill="none" stroke="currentColor" strokeWidth="2.5" strokeMiterlimit="10" strokeLinejoin="round">
        ...
        <path d="M48.871 48.815c0 5.885-4.867 10.655-10.871 10.655S27.129 54.7 27.129 48.815 31.996 34.495 38 34.495s10.871 8.435 10.871 14.32z"></path>
      </svg>
    ),
  },
];

export default function ShopLifestyle() {
  return (
      ...
      <div className="bottom">
        {lifestyles.map((item, i) => (
          <div className="shop" key={i}>
            <div className={`img ${item.className || ""}`} style={item.color ? { backgroundColor: item.color } : undefined}>
              {item.svg}
            </div>
            <h3>{item.name}</h3>
            <p>{item.desc}</p>
